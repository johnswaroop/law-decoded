    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col items-center">
        ...
        <div className="mt-12 w-full max-w-[1200px]">
          <h2 className="text-[20px] xs:text-[24px] font-georgia leading-tight text-[#281D1B] mb-4">Featured Legal Education Videos</h2>
         <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="rounded-lg border bg-card shadow-sm overflow-hidden">
              ...
              <div className="p-2">
                <h3 className="font-georgia text-sm font-semibold text-[#281D1B]">Right to Freedom of Religion</h3>
                <span className="text-orange-500 font-inter text-[10px] font-medium">16 mins</span>
              </div>
            </div>
            <div className="rounded-lg border bg-card shadow-sm overflow-hidden">
              <div className="relative aspect-video bg-muted">
              ...
              <div className="p-2">
                <h3 className="font-georgia text-sm font-semibold text-[#281D1B]">Understanding Constitutional Rights</h3>
                <span className="text-orange-500 font-inter text-[10px] font-medium">15 mins</span>
              </div>
            </div>
            <div className="rounded-lg border bg-card shadow-sm overflow-hidden">
              <div className="relative aspect-video bg-muted">
              ...
              <div className="p-2">
                <h3 className="font-georgia text-sm font-semibold text-[#281D1B]">Fundamental Rights Deep Dive</h3>
                <span className="text-orange-500 font-inter text-[10px] font-medium">18 mins</span>
              </div>
            </div>
          </div>
        </div>
